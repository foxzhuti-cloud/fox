...
jobTriggered: 'Job ejecutado',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Los enlaces de descarga de escritorio ya están disponibles en el sitio oficial, y los instaladores más recientes siguen disponibles en GitHub Releases',
