export default {
  ...
  chat: {
    ...
    exportSuccess: '会话已导出',
    exportFailed: '导出失败',
    exportFetchingMessages: '正在获取对话消息...',
    renamed: '已重命名',
    renameFailed: '重命名失败',
    renameSession: '重命名会话',
  ...
  changelog: {
    ...
    new_0_5_14_5: '更新模型列表、新增内置标识与 API 接口入口',
    ...
    new_0_6_2_1: 'Web Bridge 现在支持 /plan 命令，具有正确的运行启动和可见的命令状态',
    new_0_6_2_2: '聊天输入命令菜单现在包含 /goal 和 /subgoal 命令，包括状态、暂停、继续，完成和清除操作',
    new_0_6_2_3: 'Goal 和 subgoal 工作流程现在与会话集成，包括目标延续和状态更新',
    new_0_6_2_4: '恢复任务投递目标渠道选项，以便定时任务可以选择预期目标',
    new_0_6_2_5: '上下文 token 使用现在在重连后通过快照感知计算准确恢复',
    new_0_6_2_6: '上下文检查点压缩对慢速 Codex 摘要更可靠：Web UI 等待 5 分钟，Python bridge broker 不再在 2 分钟后切断 worker 请求',
    new_0_6_2_7: '修复聊天队列升级问题，队列中的消息不会提前跳入消息列表，包括同步的窗口',
    new_0_6_2_8: 'Clarify 提示符不再在回车时提交开放文本回复，已回答的提示符在切换会话后不再重新打开',
    new_0_6_2_9: 'Bridge 终端环境刷新和陈旧 pid 清理范围更紧密，减少 UI 中陈旧的运行时状态',
    new_0_6_2_10: '默认上下文长度现在遵循 Hermes 标准 256,000 tokens',
    new_0_6_1_1: '会话列表现在显示账户可用的所有 Profile，除非明确选择 Profile 过滤器，CLI 启动/停止/状态不再打印 node:sqlite 实验性警告',
    new_0_6_1_2: 'Clarify 和确认回复现在通过经过身份验证的聊天套接字传输到 Hermes bridge，包含响应路径测试',
    new_0_6_1_3: '导航条目和聊天会话行现在使用原生链接实现新标签页打开、复制链接和持久折叠侧边栏行为',
    new_0_6_1_4: '会话链接不再将路由 Profile 过滤器泄漏到正常会话列表，新标签页打开标签已本地化',
    new_0_6_1_5: '技能现在从活动 Profile 配置中读取 skills.external_dirs，标记外部技能，保留本地优先级，并解析外部文件',
    new_0_6_1_6: '登录 IP 锁定现在允许 10 次失败尝试，锁定登录界面显示清除锁定和重置默认登录恢复命令',
    new_0_6_1_7: '移动端和后台聊天断开被视为临时断开，然后重连从服务器恢复运行状态',
    new_0_6_1_8: 'Bridge 工具标记刷新现在在工具和运行边界处保留部分工具调用标记前缀',
    new_0_6_1_9: 'Profile 感知的会话历史操作现在删除具有 Profile 限定目标并在全球 Profile 更改时刷新历史记录',
    new_0_6_1_10: '旧版 AUTH_DISABLED 绕过已移除以支持多用户权限，AUTH_TOKEN 仍然受支持',
    new_0_6_0_1: '账户和 Profile 范围的管理现在一致地保护会话、模型、使用量、Kanban、任务、上传、媒体和相关 Hermes API',
    new_0_6_0_2: '捆绑的媒体技能仅为媒体端点使用生成的服务器令牌，并从请求的 Profile 解析 fun-codex/xAI 凭证',
    new_0_6_0_3: '单聊和群聊现在将当前 Hermes Profile 注入到运行指令中，以便技能可以发送 X-Hermes-Profile',
    new_0_6_0_4: 'delegate_task 子代理进度现在流式传输到聊天 UI，包含启动、工具、进度和完成更新',
    new_0_6_0_5: '停止或中止运行会清除临时事件，防止陈旧的中止状态泄漏到下一个聊天',
    new_0_6_0_6: '更新账户管理、默认凭证、账户/Profile 管理、上传/下载和捆绑媒体技能的文档和网站内容',
    new_0_6_0_7: '添加 CLI 维护命令用于清除登录 IP 锁定和重置默认 admin / 123456 登录',
    new_0_6_0_8: '版本 0.6.0 是单用户和多用户 Web UI 之间的分界线。如果多用户模式导致问题，请提交问题并在需要时回滚到 0.5.35 单用户版本',
