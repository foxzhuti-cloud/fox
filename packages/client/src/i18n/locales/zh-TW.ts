export default {
  ...
  chat: {
    ...
    exportFailed: '匯出失敗',
    exportFetchingMessages: 'Fetching conversation messages...',
    renamed: '已重新命名',
    renameFailed: '重新命名失敗',
  ...
  changelog: {
    ...
    new_0_5_14_5: '更新模型清單，新增內建標識與 API 介面入口',
    ...
    new_0_5_17_6: 'Add handwritten fonts for Comic theme',
    ...
    new_0_6_2_1: 'Web Bridge 現在支援 /plan 命令，具有正確的執行啟動和可見的命令狀態',
    new_0_6_2_2: '聊天輸入命令選單現在包含 /goal 和 /subgoal 命令，包括狀態、暫停、繼續、完成和清除操作',
    new_0_6_2_3: 'Goal 和 subgoal 工作流程現在與工作階段整合，包括目標延續和狀態更新',
    new_0_6_2_4: '恢復任務投遞目標管道選項，以便定時任務可以選擇預期目標',
    new_0_6_2_5: '上下文 token 使用現在在重連後透過快照感知計算準確恢復',
    new_0_6_2_6: '上下文檢查點壓縮對慢速 Codex 摘要更可靠：Web UI 等待 5 分鐘，Python bridge broker 不再在 2 分鐘後切斷 worker 請求',
    new_0_6_2_7: '修復聊天佇列升級問題，佇列中的訊息不會提前跳入訊息列表，包括同步的視窗',
    new_0_6_2_8: 'Clarify 提示符不再在回車時提交開放文字回覆，已回答的提示符在切換工作階段後不再重新開啟',
    new_0_6_2_9: 'Bridge 終端機環境重新整理和過時 pid 清理範圍更緊密，減少 UI 中過時的執行階段狀態',
    new_0_6_2_10: '預設上下文長度現在遵循 Hermes 標準 256,000 tokens',
    new_0_6_1_1: '工作階段列表現在顯示帳戶可用的所有 Profile，除非明確選擇 Profile 過濾器，CLI 啟動/停止/狀態不再列印 node:sqlite 實驗性警告',
    new_0_6_1_2: 'Clarify 和確認回覆現在通過經過身份驗證的聊天通訊端傳輸到 Hermes bridge，包含回應路徑測試',
    new_0_6_1_3: '導航項目和聊天工作階段列現在使用原生連結實現新標籤頁開啟、複製連結和持久折疊側邊欄行為',
    new_0_6_1_4: '工作階段連結不再將路由 Profile 過濾器洩漏到正常工作階段列表，新標籤頁開啟標籤已本地化',
    new_0_6_1_5: '技能現在從活動 Profile 設定中讀取 skills.external_dirs，標記外部技能，保留本地優先順序，並解析外部檔案',
    new_0_6_1_6: '登入 IP 鎖定現在允許 10 次失敗嘗試，鎖定登入介面顯示清除鎖定和重設預設登入恢復命令',
    new_0_6_1_7: '行動端和後台聊天斷開被視為臨時斷開，然後重連從伺服器恢復執行狀態',
    new_0_6_1_8: 'Bridge 工具標記重新整理現在在工具和執行階段邊界處保留部分工具呼叫標記前置字元',
    new_0_6_1_9: 'Profile 感知的工作階段歷史操作現在刪除具有 Profile 限定目標並在全球 Profile 變更時重新整理歷史記錄',
    new_0_6_1_10: '舊版 AUTH_DISABLED 繞過已移除以支援多使用者權限，AUTH_TOKEN 仍然受支援',
    new_0_6_0_1: '帳戶和 Profile 範圍的管理現在一致地保護工作階段、模型、使用量、Kanban、工作、上傳、媒體和相關 Hermes API',
    new_0_6_0_2: '捆綁的媒體技能僅為媒體端點使用生成的伺服器權杖，並從請求的 Profile 解析 fun-codex/xAI 憑證',
    new_0_6_0_3: '單聊和群聊現在將目前 Hermes Profile 注入到執行指令中，以便技能可以傳送 X-Hermes-Profile',
    new_0_6_0_4: 'delegate_task 子代理進度現在串流傳輸到聊天 UI，包含啟動、工具、進度和完成更新',
    new_0_6_0_5: '停止或中止執行會清除暫時事件，防止過時的中止狀態洩漏到下一個聊天',
    new_0_6_0_6: '更新帳戶管理、預設憑證、帳戶/Profile 管理、上傳/下載和捆綁媒體技能的檔案和網站內容',
    new_0_6_0_7: '新增 CLI 維護命令用於清除登入 IP 鎖定和重設預設 admin / 123456 登入',
    new_0_6_0_8: '版本 0.6.0 是單使用者和多使用者 Web UI 之間的分界線。如果多使用者模式導致問題，請提交問題並在需要時回滾到 0.5.35 單使用者版本',
