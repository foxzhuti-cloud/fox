export default {
  ...
  sidebar: {
    ...
    reloadClientVersion: 'Neu laden fur v{version}',
    logout: 'Abmelden',
...
jobTriggered: 'Job ausgelost',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Desktop-Download-Links sind jetzt auf der offiziellen Website verfügbar, aktuelle Installer bleiben außerdem über GitHub Releases verfügbar',
