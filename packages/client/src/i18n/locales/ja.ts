export default {
  ...
  sidebar: {
    ...
    connected: '接続済み',
    disconnected: '未接続',
    updateTip: 'ターミナルで "hermes-web-ui update" を実行して更新',
    reloadClientVersion: 'v{version} 用にリロード',
    logout: 'ログアウト',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Desktop のダウンロードリンクを公式サイトに追加し、最新インストーラーは引き続き GitHub Releases からも取得できます',
