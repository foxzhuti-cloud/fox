...
jobTriggered: 'Job declenche',
  ...
  changelog: {
    ...
    new_0_6_7_9: 'Les liens de téléchargement desktop sont maintenant disponibles sur le site officiel, et les derniers installateurs restent disponibles via GitHub Releases',
